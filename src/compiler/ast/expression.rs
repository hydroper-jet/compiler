...
pub enum Expression {
    ...
    ArrowEmptyParameters(ArrowEmptyParameters),
    ...
    WithTypeAnnotation(ExpressionWithTypeAnnotation),
    ...
    UndefinedType(UndefinedTypeExpression),
...
impl Expression {
    pub fn location(&self) -> Location {
        match self {
            ...
            Self::ArrowEmptyParameters(e) => e.location.clone(),
            Self::Paren(e) => e.location.clone(),
            Self::UndefinedLiteral(e) => e.location.clone(),
            ...
            Self::WithTypeAnnotation(e) => e.location.clone(),
            Self::Binary(e) => e.location.clone(),
            Self::Conditional(e) => e.location.clone(),
            Self::ArrowFunction(e) => e.location.clone(),
            Self::Assignment(e) => e.location.clone(),
            Self::Rest(e) => e.location.clone(),
            ...
            Self::UndefinedType(e) => e.location.clone(),
